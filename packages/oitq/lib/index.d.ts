...
declare module 'oitq'{
    ...
    export function getOneBotConfigPath(dir?: string): string;
    ...
    export namespace Quester{
        ...
        export function create(config: Quester.Config = {}):Quester
    }
    export class Router extends KoaRouter {
        wsStack: Server[];
        whiteList: Path[];
        register(...args: Parameters<KoaRouter['register']>): KoaRouter.Layer;
        ws(path: string, server: http.Server): Server<import("ws").WebSocket>;
    }
    ...
    export function assert(filter: any, e: any): boolean;
    ...
    export class OneBot {
        ...
        protected wsr: Set<WebSocket>;
        protected queue_running: boolean;
        protected filter: any;
        protected timestamp: number;
        constructor(app: App, bot: Bot, config?: OneBotConfig, port?: any);
        /**
         * 上报事件
         */
        protected _dispatch(unserialized: any): void;
        /**
         * 上报业务事件
         */
         ...
         * 处理http请求
         */
        protected _httpRequestHandler(ctx: any): Promise<any>;
        /**
         * 处理ws消息
         */
         ...
         * 调用api
         */
        protected apply(req: OneBotProtocol): Promise<string>;
        /**
         * 快速操作
         */
    ...
    export const APIS: (keyof Client)[];
    export const ARGS: {
        [key: string | symbol]: string[];
    };
    export function toHump(action: string): string;
    export const BOOLS: string[];
    ...
    export function transNotice(data: any): void;
    ...
    export declare class Command<A extends any[] = any[], O extends {} = {}> {
        ...
        execute(argv: string | Argv): Promise<boolean|MessageRet|Sendable>;
